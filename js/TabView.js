  ...
  return (
    <View style={[styles.container, props.sceneStyle]}>
      ...
      <Button onPress={() => {
        drawer.close();
        Actions.tab1();
      }}><Text>Switch to tab1</Text></Button>
      <Button onPress={() => {
        drawer.close();
        Actions.tab2();
      }}><Text>Switch to tab2</Text></Button>
      <Button onPress={() => {
        drawer.close();
        Actions.tab3();
      }}><Text>Switch to tab3</Text></Button>
      <Button onPress={() => {
        drawer.close();
        Actions.tab4();
      }}><Text>Switch to tab4</Text></Button>
      <Button onPress={() => {
        drawer.close();
        Actions.tab5();
      }}><Text>Switch to tab5</Text></Button>
      <Button onPress={() => {
        drawer.close();
        Actions.echo();
      }}><Text>push new scene</Text></Button>
    </View>
  );
};
